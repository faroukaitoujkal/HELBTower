public abstract class NotCollectibleGameElement {
    ...
    public NotCollectibleGameElement(int posX, int posY, String[] imagePaths){
        this.posX = posX ; 
        this.posY = posY ;
        this.IMAGE_PATHS = imagePaths;
    }

    public NotCollectibleGameElement(int posX, int posY, String[] imagePaths, String name) {
        this.posX = posX ; 
        this.posY = posY ;
        this.IMAGE_PATHS = imagePaths;
        this.name = name;
